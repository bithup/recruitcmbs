...
public class EntityUtil {
    ...
    private final String bean_package = "com.yunxiaoyuan." + moduleName + ".entity";

    private final String mapper_package = "com.yunxiaoyuan." + moduleName + ".mapper";
