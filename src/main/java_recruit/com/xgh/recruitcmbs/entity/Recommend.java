...
public class Recommend implements Serializable {
    ...
    public Recommend(long id,long memberId,int kind,String context,String remart,int status,Date createDate,Date updateDate,int adopt,String data1,long data2,int data3,Double data4){
        super();
        this.id = id;
