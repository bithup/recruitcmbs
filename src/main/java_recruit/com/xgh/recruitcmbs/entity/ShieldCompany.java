...
public class ShieldCompany implements Serializable {
	...
	public ShieldCompany() { super(); }

	public ShieldCompany(long id) {
		super();
		this.id=id;
	}

	public ShieldCompany(long id,long memberId,long companyId,Date createDate,Date updateDate,int status,long data1,long data2,String data3,String data4,String data5,int data6,int data7,Double data8){
		super();
		this.id = id;
