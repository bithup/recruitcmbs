...
public class ProfessionalSkills implements Serializable {
    ...
    public ProfessionalSkills() { super(); }

    public ProfessionalSkills(long id) {
        super();
        this.id=id;
    }

    public ProfessionalSkills(long id,long resumeId,String skillName,int skillLevel,String utilityTime,Date createDate,Date updateDate,int status,long data1,long data2,String data3,String data4,String data5,int data6,int data7,Double data8){
        super();
        this.id = id;
    ...
    public void setUtilityTime(String utilityTime){
        this.utilityTime = utilityTime;
    }
