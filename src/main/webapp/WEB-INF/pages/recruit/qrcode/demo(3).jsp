...
<body>
	<div class="con_top">
		<div class="numContent">
			<span id="numContent">教育放上去推广人:1359****421为你服务</span>
		</div>
		<div class="num_wrapper">
			<h3 style="margin-top: 30px">邀请口令：</h3>
			<div class="num"><span id="num">测试用内容</span></div>
			<div class="remind_icon"><img src="images/guide.png" alt=""></div>
		</div>
	...
	<div class="body_mask">
		<h1 class="num1"><i>点击右上角的</i><img src="images/sheng.png" alt=""></h1>
		<h1 class="num2">选择在浏览器中打开此页面</h1>
		<div class="guide"><img src="images/arrow.png" alt=""></div>
	</div>
	<script>
		$(function(){
